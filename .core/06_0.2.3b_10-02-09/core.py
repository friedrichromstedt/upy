...
class undarray:
	...
	def __init__(self,
		...
		if isinstance(object, undarray):
			...
			# Use id(sigma) as source name.  This should be persistent, 
			# because it is shared by all Dependencies ever depending
			# on that sigma.
			self.characteristic = Characteristic(shape = self.value.shape)
			self.characteristic.set_dependency(id(sigma), dependency)
...
class Add(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.add, '__radd__')

add = Add()

class Subtract(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.subtract, '__rsub__')

subtract = Subtract()

class Multiply(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.multiply, '__rmul__')

multiply = Multiply()

class Divide(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.divide, '__rdiv__')

divide = Divide()

class Power(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.power, '__rpow__')
...
class Less(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.less, '__gt__')

less = Less()

class LessEqual(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.less_equal, '__ge__')

less_equal = LessEqual()

class Greater(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.greater, '__lt__')

greater = Greater()

class GreaterEqual(ufuncWrap):
	def __init__(self):
		ufuncWrap.__init__(self, numpy.greater_equal, '__le__')
